    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-sm mb-4">
              Building Dreams, Brick by Brick in Bhopal. Your trusted partner in
              real estate.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-sm">
                  Third Floor, Plot No 155, Service Rd, Near Axis Bank, Zone-I,
            ...
            <div className="flex space-x-4 mt-6">
              <a
                href="https://www.instagram.com/bluetickrealty/"
                target="blank"
              ...
              <a
                href="https://www.linkedin.com/company/bluetickrealty/"
                target="blank"
                className="w-9 h-9 bg-gray-800 rounded-full flex items-center justify-center hover:bg-[#DAEC8B] hover:text-gray-900 transition-colors"
              >
                <Linkedin size={18} />
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-sm">
            © 2025 Bluetick Reality. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
